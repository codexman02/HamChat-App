...
<div>
  ...
  <div className="w-full py-6 my-2">
    ...
    <div className="card_container grid grid-cols-4 gap-6 px-16 py-5">
{/* CARD START HERE  */}
    <div className="card w-full border border-solid border-gray-200 flex flex-col gap-2 py-4 rounded-lg shadow-md px-6">
    <video autoPlay muted loop controls={false} className="w-1/3 mx-auto h-16 ">
          <source src="./message.mp4" type="video/mp4"></source>
          </video>
         <div className="w-full flex justify-center flex-col items-center g grow my-2 px-4">
         
         <h2 className="title text-3xl font-normal text-gray-800 text-center">Messaging </h2>
    ...
    <video autoPlay muted loop controls={false} className="w-1/3 mx-auto h-16 ">
         ...
         <h2 className="title text-3xl font-normal text-gray-800 text-center">GroupChat</h2>
         <p className="description text-sm py-1 text-center mt-2">
    ...
    <video autoPlay muted loop controls={false} className="w-1/3 mx-auto h-16 ">
         ...
         <h2 className="title text-3xl font-normal text-gray-800 text-center">File Support</h2>
         <p className="description text-sm py-1 text-center mt-2">
    ...
    <video autoPlay muted loop controls={false} className="w-1/3 mx-auto h-16 ">
         ...
         <h2 className="title text-3xl font-normal text-gray-800 text-center">Privacy</h2>
         <p className="description text-sm py-1 text-center mt-2">
